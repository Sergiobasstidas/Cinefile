<template>
  <div>
    <v-card class="navbar d-flex justify-center" flat height="100px">
      <v-toolbar flat height="100px" max-width="78%">
        ...
        <v-btn class="px-0" plain :to="{ name: 'Login' }">Registrate</v-btn>
        <v-btn icon>
