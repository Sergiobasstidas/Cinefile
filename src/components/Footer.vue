<template>
  <v-footer class="footer" dark padless color="#131720">
    <v-card
      flat
      tile
      class="white--text text-center mt-6"
      color="#131720"
      width="100%"
    >
      ...
      <v-card-text
        class="icons py-0 d-none d-sm-flex justify-space-between flat"
      >
        <v-btn icon plain>
      ...
      <v-card-text class="d-flex flex-row justify-center py-sm-0 pt-0 pt-md-2">
        ...
        <v-btn class="about d-none d-md-flex" plain to="/movies"
          >Peliculas</v-btn
        >
        <v-btn class="about d-none d-md-flex" plain to="/series">Series</v-btn>
      </v-card-text>

      <v-divider></v-divider>

      <v-card-text class="derechos white--text">
        &copy; {{ new Date().getFullYear() }} Cinefile. Todos los derechos
        reservados.
      </v-card-text>
    </v-card>
  </v-footer>
